...
(() => {
  const copy = {
    en: { sending:'Submitting inquiry…', success:'Inquiry submitted successfully', reference:'Request Reference', date:'Request Date & Time', received:'Your inquiry has been received. Please keep this reference number.', emailSent:'Notification email sent to Agro-Zia.', emailFailed:'Inquiry saved, but notification email could not be sent.', copy:'Copy Reference', error:'Unable to submit: ', required:'Please provide a product/category and at least an email or phone number.' },
    ru: { sending:'Отправка запроса…', success:'Запрос успешно отправлен', reference:'Номер заявки', date:'Дата и время заявки', received:'Ваш запрос получен. Сохраните этот номер.', emailSent:'Уведомление отправлено в Agro-Zia.', emailFailed:'Запрос сохранён, но уведомление по электронной почте не отправлено.', copy:'Копировать номер', error:'Не удалось отправить: ', required:'Укажите продукт/категорию и Email или телефон.' },
    fa: { sending:'در حال ثبت درخواست…', success:'درخواست با موفقیت ثبت شد', reference:'شماره پیگیری', date:'تاریخ و زمان درخواست', received:'درخواست شما دریافت شد. لطفاً این شماره را نگهداری کنید.', emailSent:'ایمیل اطلاع‌رسانی همراه با پیوست برای Agro-Zia ارسال شد.', emailFailed:'درخواست ثبت شد، اما ایمیل اطلاع‌رسانی ارسال نشد.', copy:'کپی شماره', error:'ثبت درخواست انجام نشد: ', required:'محصول/دسته و حداقل ایمیل یا شماره تلفن را وارد کنید.' },
    ar: { sending:'جارٍ إرسال الطلب…', success:'تم إرسال الطلب بنجاح', reference:'رقم المرجع', date:'تاريخ ووقت الطلب', received:'تم استلام طلبك. يرجى الاحتفاظ بهذا الرقم.', emailSent:'تم إرسال إشعار إلى Agro-Zia.', emailFailed:'تم حفظ الطلب، ولكن تعذر إرسال إشعار البريد الإلكتروني.', copy:'نسخ الرقم', error:'تعذر إرسال الطلب: ', required:'يرجى إدخال المنتج/الفئة والبريد الإلكتروني أو الهاتف.' },
    uz: { sending:'So‘rov yuborilmoqda…', success:'So‘rov muvaffaqiyatli yuborildi', reference:'So‘rov raqami', date:'So‘rov sanasi va vaqti', received:'So‘rovingiz qabul qilindi. Ushbu raqamni saqlang.', emailSent:'Bildirishnoma Agro-Zia ga yuborildi.', emailFailed:'So‘rov saqlandi, ammo email bildirishnomasi yuborilmadi.', copy:'Raqamni nusxalash', error:'So‘rov yuborilmadi: ', required:'Mahsulot/kategoriya va email yoki telefon kiriting.' },
